...
Script 1 features steps for raw data set extraction and data set cleaning.       
...
+ Conversion of the original code into a single large function to download the source data set and to clean its column names.  
...
+ Reduce code duplication by creating a single function which outputs commune or country level Laspeyeres price indexes.  
